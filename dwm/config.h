...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_lightgrey , col_black  ,col_black },
	[SchemeSel]  = { col_white , col_darkgrey   ,col_lightgrey},
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_black, "-nf", col_lightgrey, "-sb", col_darkgrey, "-sf", col_white, NULL };
